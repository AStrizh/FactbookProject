...
CREATE TABLE `economy` (
	...
	`Exports` Decimal( 4, 1 ),
	`Imports` Decimal( 4, 1 ),
	`GDPAgriculture` Decimal( 4, 1 ),
	`GDPIndustry` Decimal( 4, 1 ),
	`GDPServices` Decimal( 4, 1 ),
	...
	`ExportsTotal` BIGINT,
	`ExportsCommodities` TEXT,
	`ExportsPartners` VARCHAR(200),
	`ImportsTotal` BIGINT,
	`ImportsCommodities` TEXT,
	`ImportsPartners` VARCHAR(200),
...
CREATE TABLE `communications` (
	...
	`CountryCode` CHAR(2),
	`TotalFixedLines` INT, 
	`FixedLinesPer100` INT,
	`TotalCellular` INT,
	`CellularPer100` INT,
	`TelephoneGeneralAssessment` TEXT,
	`TelephoneSystemDomestic` TEXT,
	`TelephoneSystemInternational` TEXT,
	`BroadcastMedia` TEXT,
	`InternetCode` VARCHAR(5),
	`InternetUsers` INT,
	`InternetUsersPCT` DECIMAL( 4, 1 )
);
...
CREATE TABLE `transportation` (
	...
	`PavedRunways` INT,
	`PavedOver3047m` INT,
	`PavedBetween2438TO3047m` INT,
	`PavedBetween1524TO2437m` INT,
	`PavedBetween914TO1523m` INT,
	`PavedUnder914m` INT,
	`UnpavedRunways` INT,
	`UnpavedOver3047m` INT,
	`UnpavedBetween2438TO3047m` INT,
	`UnpavedBetween1524TO2437m` INT,
	`UnpavedBetween914TO1523m` INT,
	`UnpavedUnder914m` INT,
	`Heliports` INT,
	`Pipelines` VARCHAR(200),
	`TotalRailwayKM` INT,
	`BroadGaugeKM` INT,
	`StandardGaugeKM` INT,
	`NarrowGaugeKM` INT,
	...
	`RiverPort` VARCHAR(200),
	`OilTerminal` VARCHAR(200),
	`DryCargoPort` VARCHAR(200),
	`ContainerPort` VARCHAR(200),
